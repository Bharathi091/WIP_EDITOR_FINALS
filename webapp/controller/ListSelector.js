sap.ui.define([
		...
		return BaseObject.extend("zprs.wipeditor.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias zprs.wipeditor.model.ListSelector
			 */
			 ...
			 * @return {zprs.wipeditor.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
