sap.ui.define([
	...
	return BaseController.extend("billedit.controller.LineItemTransfers", {
		...
		onInit: function() {
			...
			this.bus.subscribe("lineItemTransferMode", "row", this._getButtonEvent, this);
